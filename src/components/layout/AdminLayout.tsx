...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row w-full">
      ...
      <div className="hidden lg:flex fixed inset-y-0 left-0 z-50 w-72 flex-col border-r border-border/40 bg-background/95 backdrop-blur-md">
        ...
        <div className="border-t border-border/40 p-4">
          <form action={logout}>
            <button
              type="submit"
              className="w-full group flex items-center px-3 py-2.5 text-sm font-medium rounded-xl text-muted-foreground hover:bg-slate-100 hover:text-foreground transition-colors"
            >
      ...
      <div className="lg:pl-72 flex-1 flex flex-col min-h-screen w-full pb-16 lg:pb-0">
        ...
        <div className="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between border-b border-border/40 bg-background/95 backdrop-blur-md px-4 shadow-sm lg:hidden">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-border/40 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] pb-safe">
